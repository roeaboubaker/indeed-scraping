...
url = "https://www.indeed.com/jobs?q=engineer&l=&from=searchOnDesktopSerp&vjk=5d188442675460eb"
...
def get_data(job_listing):
    ...
    return ('engineer',title, company, location, date_posted)
...
df.to_csv('engineer_job.csv', index=False)

print("Data saved to engineer_job.csv")
